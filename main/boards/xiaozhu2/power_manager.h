...
private:
    ...
    gpio_num_t charging_pin_ = GPIO_NUM_9;
    ...
    const int kTemperatureReadInterval = 10; // �? 10 秒读取一次温�?
    ...
    void CheckBatteryStatus() {
        ...
        // 如果电池电量数据充足，则�? kBatteryAdcInterval �? tick 读取�?次电池电量数�?
        ticks_++;
    ...
    void ReadTemperature() {
        ...
        if (abs(temperature - current_temperature_) >= 3.5f) {  // 温度变化超过3.5°C才触发回�?
