...
#define MAIN_EVENT_CHAT_KEEPALIVE_TIMEOUT (1 << 13)
...
private:
    ...
    esp_timer_handle_t chat_keepalive_timer_handle_ = nullptr;
    ...
    bool pending_keepalive_reconnect_ = false;
    ...
    void HandleChatKeepAliveTimeoutEvent();
    ...
    void ResetChatKeepAliveTimer();
    void StopChatKeepAliveTimer();
